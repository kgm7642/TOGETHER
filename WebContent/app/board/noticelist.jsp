				...
				<div class="inner">
					<table class="list"
						...
						<tr align="center" valign="middle">
							<th width="20%" style="text-align:center;padding:10px;background-color:#E0EDF2;color:black;"><strong>분류</strong></th>
							<th width="40%" style="text-align:center;padding:10px;background-color:#E0EDF2;color:black;"><strong>제목</strong></th>
							<th width="10%" style="text-align:center;padding:10px;background-color:#E0EDF2;color:black;"><strong>작성자</strong></th>
							<th width="20%" style="text-align:center;padding:10px;background-color:#E0EDF2;color:black;"><strong>날짜</strong></th>
							<th width="10%" style="text-align:center;padding:10px;background-color:#E0EDF2;color:black;"><strong>조회수</strong></th>
						</tr>
						<c:choose>
							<c:when test="${boardList.size()>0 and boardList != null }">
								<c:forEach var="board" items="${boardList}">
									<tr class="board" id="board${board.boardnum}" onClick="location.href='${cp}/board/NoticeView.bo?boardnum=${board.boardnum}&page=${page}&keyword=${keyword}'" onmouseover="this.style.background='#eeeeeb'" onmouseout="this.style.background='white'">
					...
					<table class="pagination"
						...
						<tr align="center" valign="middle">
							<td><c:if test="${page>1}">
									<a href="${cp}/board/NoticeList.bo?page=${page-1}&keyword=${keyword}">&lt;</a>
									...
									<c:choose>
										...
										<c:otherwise>
											<a href="${cp}/board/NoticeList.bo?page=${i}&keyword=${keyword}">${i}</a>
										</c:otherwise>
									</c:choose>
...
<script>
		function search(){
			...
			location.href="${cp}/board/NoticeList.bo?keyword="+q.value
		}
		</script>
