			...
			<section id="main" class="main">
				<div class="inner">
					...
					<div class="search_area">
						<input type="search" id="q" name="q" size=50 placeholder="모임 이름을 입력해주세요. 최소 2글자 이상."> <input type="button"
					...
					<table class="list">
						<tr align="center" valign="middle">
							<th width="40%" style="text-align: center;padding:12px; background-color: #E0EDF2"">모임이름</th>
							...
							<th width="15%" style="text-align: center;padding:12px; background-color: #E0EDF2"">신고수</th>
						</tr>
						<c:choose>
							<c:when test="${moimList.size()>0 and moimList != null }">
								<c:forEach var="moim" items="${moimList}">
									<tr class="moim" id="moim${moim.moimnum}" class="myCursor" 
										...
										onClick="location.href='${cp}/admin/AdminGetMoimInfo.ad?moimnum=${moim.moimnum}&page=${page}&keyword=${keyword}'" 
					...
					<table class="pagination">
						<tr align="center" valign="middle">
							<td><c:if test="${page>1}">
									<a
										href="${cp}/admin/MoimList.ad?page=${page-1}&keyword=${keyword}">&lt;</a>
									...
									<c:choose>
										...
										<c:otherwise>
											<a
												href="${cp}/admin/MoimList.ad?page=${i}&keyword=${keyword}">${i}</a>
										</c:otherwise>
									</c:choose>
...
<script>
	function search() {
		...
		location.href = "${cp}/admin/MoimList.ad?keyword=" + q.value
	}
</script>
</html>