			...
			<section id="main" class="main">
				<div class="inner">
						...
						<c:choose>
							<c:when test="${boardList.size()>0 and boardList != null }">
								<c:forEach var="board" items="${boardList}">
									<tr class="board" id="board${board.boardnum}" onClick="location.href='${cp}/admin/AdminNoticeView.ad?boardnum=${board.boardnum}&page=${page}&keyword=${keyword}'" onmouseover="this.style.background='#eeeeeb'" onmouseout="this.style.background='white'">
					...
					<table class="pagination"
						...
						<tr align="center" valign="middle">
							<td><c:if test="${page>1}">
									<a href="${cp}/admin/AdminNoticeList.ad?page=${page-1}&keyword=${keyword}">&lt;</a>
									...
									<c:choose>
										...
										<c:otherwise>
											<a href="${cp}/admin/AdminNoticeList.ad?page=${i}&keyword=${keyword}">${i}</a>
										</c:otherwise>
									</c:choose>
					...
					<table
						...
						<tr align="right" valign="middle">
							<td><a class="write button primary large"
								href="${cp}/admin/AdminNoticeWrite.ad?page=${page}">글쓰기</a></td>
						</tr>
...
<script>
		function search(){
			...
			location.href="${cp}/admin/AdminNoticeList.ad?keyword="+q.value
		}
		</script>
