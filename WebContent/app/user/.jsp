   ...
   <div id="page-wrapper">
      ...
      <div id="wrapper">
         ...
         <form method="post" name="joinForm"
            action="${pageContext.request.contextPath}/user/UserMypage.us" onsubmit="return sendPW()">
            <table>
               <tr>
                  <th><label for="userpw"><span style="font-size:1.5em;"><strong>비밀번호 확인</strong></span></label></th>
                  <td><input type="password" name="userpw"></td>
                  <td><input type="submit" value="확인" class="button primary" style="width:150px;"></td>
               </tr>
            </table>
         </form>
