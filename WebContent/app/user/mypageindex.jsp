   ...
   <div id="page-wrapper">
      ...
      <div id="wrapper">
		<table>
			<tr>
              	<td style="width:33%;">
              		<a class="button primary fit" href="${pageContext.request.contextPath}/user/UserMyInfoUpdatePw1.us">UPDATE MY INFO</a>
              	</td>
              	<td style="width:33%;">
              		<a class="button fit" href="${pageContext.request.contextPath}/user/UserMyInfoUpdatePw2.us">resign</a>
              	</td>
            </tr>
            <tr>
            	<td style="margin:10px;">${session.userid} 님의 개인 정보를 수정할 수 있습니다.</td>
            	<td style="margin:10px;">회원 탈퇴로 이동합니다.</td>
            </tr>
            <tr>
	            <td>
    	        </td>
            ...
            <tr>
            	<td style="width:33%;">
              		<a class="button fit" href="${pageContext.request.contextPath}/user/UserFriendListOK.us">Friend</a>
              	</td>
              	<td style="width:33%;">
              		<a class="button primary fit" href="${pageContext.request.contextPath}/moim/MyMoim.mo">MY MOIM</a>
              	</td>            
            </tr>
            <tr>
            	<td style="margin:10px;">${session.userid} 님의 follow 또는 following 리스트를 확인 할 수 있습니다.</td>
            	<td style="margin:10px;">${session.userid} 님이 현재 활동중인 모임을 확인할 수 있습니다.</td>
            </tr>
        </table>
