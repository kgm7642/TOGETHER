...
<%@page import="com.project.app.moim.dto.FollowDTO"%>
<!DOCTYPE HTML>
<html>
<head>
	...
	<div id="page-wrapper">
		...
		<div id="wrapper">
			...
			<form name="FriendListForm"
				action="${pageContext.request.contextPath}/user/UserFindFriendOK.us"
				style="width: 70%; align: center; margin-left: auto; margin-right: auto;"
				method="post" onsubmit="return sendit();">
				<table>
					<tr>
						<td><a
							href="${pageContext.request.contextPath}/user/UserFriendListOK.us"
							class="button primary fit">FOLLOW</a></td>
						<td><a
						...
						<td><a
							...
							class="button fit">SEARCH</a></td>
					</tr>
				</table>
				<table>
					<c:forEach items="${follows}" var="follow">
						<tr style="text-align: center;">
							<td width="33%">${follow.followid}</td>
							<td width="34%">${follow.regdate}</td>
							<td width="33%"><a
								href="${pageContext.request.contextPath}/user/UserDeleteFriendOK.us?followid=${follow.followid}"
								class="button fit">REMOVE</a></td>
						</tr>
					</c:forEach>
				</table>
			</form>
