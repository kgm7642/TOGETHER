			...
			<section id="main" class="main">
				<div class="inner">
					<form name="FriendListForm"
						action="${pageContext.request.contextPath}/user/UserFollowingListOK.us?userid=${user.userid}"
						...
						<table>
							<tr>
								...
								<td><a
									...
									class="button primary fit">FOLLOWING</a></td>
								<td><a
						...
						<table>
							<c:forEach items="${users}" var="user">
								<tr style="text-align: center;">
									...
									<td>${user.regdate}</td>
									<td><a
										href="${pageContext.request.contextPath}/user/DeleteFollowingOK.us?followid=${user.userid}"
