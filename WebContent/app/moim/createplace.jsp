			...
			<div id="page-wrapper">
				...
				<!-- Menu -->
					...
					<section id="banner" data-video="${cp}/images/banner">
						<div class="inner">
							<header>
								<h1>CREATE ${session.userid}'s MOIM</h1>
							</header>
						</div>
						<c:if test="${session.userid != null}">
								...
								<div class="inner">
									...
									<div style="text-align:center;">
										<div style="width:100%;display:inline-block;">
											...
											<div style="font-size:20px;float:right;margin-top:40px;"><span style="font-weight:bold;color:#579AB7">① 모임 장소 설정 </span> &nbsp;&#187; <span> ② 모임 정보 입력</span> &nbsp;&#187; <span> ③ 모임 생성 완료</span></div>
										</div>
									</div>
									<hr>
									    ...
									    <div id="menu_wrap" class="bg_white">
									        <div class="option">
									            ...
									            <form onsubmit="searchPlaces(); return false;">
									            	<b style="color:black;font-weight:bold;">검색어를 입력해 주세요.</b><input type="text" value="롯데월드" id="keyword" size="15" style="color:black;font-weight:bold;"> 
									...
									<hr>
									<form action="${cp}/moim/CreatePlaceOk.mo" name="placeform" method="post" onsubmit="return sendPlace()">
										...
										<div style="text-align:center;">
											<div style="width:100%;display:inline-block;">
												<input type="button" id="gohome" value="홈으로" style="float:left;" onclick="location.href='${cp}/index/Index.ix'" class="button primary">
												<input type="submit" value="다음 단계" style="float:right;" class="button primary">
											</div>
										</div>
									</form>
								</div>	
