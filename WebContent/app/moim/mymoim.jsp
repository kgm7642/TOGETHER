                     ...
                     <section id="main" class="main">
                        <div class="inner">
                           <br><div style="margin:10px;">
                           		<span style="font-size:2em;"><strong>&lt ${session.userid} : 방장인 모임 &gt</strong></span>
                           ...
                           <table class="mymoimlist">
                              ...
                              <c:choose>
                                 <c:when test="${myMoimList1.size()>0 and myMoimList1 != null }">
                                    <c:forEach var="moim" items="${myMoimList1}">
                                       <c:choose>
                           ...
                           <table class="pagination">
                              <tr align="center" valign="middle">
                                 <td>
                                    <c:if test="${page>1}">
                                       <a href="${cp}/moim/MyMoim.mo?page=${page-1}">&lt;</a>
                                    </c:if>
                                    <c:forEach begin="${startPage}" end="${endPage}" step="1" var="i">
                                       <c:choose>
                                          ...
                                          <c:otherwise>
                                             <a href="${cp}/moim/MyMoim.mo?page=${i}">${i}</a>
                                          </c:otherwise>
                                       </c:choose>
                                    </c:forEach>
                           ...
                           <a href = "${cp}/moim/MyMoimAll.mo" class="button fit" style="width:30%; display: inline-block; float: right;">참여중인 모든 모임 보기</a>
                        </div>
                     </section>
                     
                     <section id="main" class="main">
                        <div class="inner">
                           <div style="margin:10px;"><h2>${session.userid}: 강퇴된 모임</h2></div>
                           <c:choose>
                              <c:when test="${fire != null}">
                                 <table class="fire">
                                    <tr align="center" valign="middle">
                                       <th width="20%">아이디</th>
                                       <th colspan="2" width="60%">강퇴메세지</th>
                                    </tr>
                                    <tr>
                                       <td>${fire.userid}</td>
                                       <td>${fire.message}</td>
                                       <td><a class="button primary fit" href= "${cp}/moim/BanMoimOk.mo?message=${fire.message}">확인</a></td>
                                    </tr>            
                                 </table>
                              </c:when>
                              <c:otherwise>
