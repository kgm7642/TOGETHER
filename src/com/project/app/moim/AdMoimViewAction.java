...
public class AdMoimViewAction implements Action{
	@Override
	public ActionForward execute(HttpServletRequest req, HttpServletResponse resp) throws Exception {
		...
		//조회수
		if(!mdto.getUserid().equals(userid.getUserid())) {
			mdao.updateViews(recruitnum);
			mdto.setReadcnt((mdto.getReadcnt()+1));
...
//		req.setAttribute("replies",mdao.getReplies(recruitnum));
		...
		forward.setPath("/app/moim/admoimview.jsp");
		return forward;
	}
}