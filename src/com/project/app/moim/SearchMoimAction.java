...
public class SearchMoimAction implements Action {
	@Override
...
//		그때는 endPage를 가장 마지막 페이지 번호로 바꿔준다.
		...
		req.setAttribute("moimList", mdao.getMoimList(startRow,endRow,keyword));
		...
		forward.setPath("/app/moim/searchmoim.jsp");
		return forward;
	}
}
