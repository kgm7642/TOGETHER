...
public class MyMoimAllListAction implements Action {
@Override
...
//		그때는 endPage를 가장 마지막 페이지 번호로 바꿔준다.
		...
		req.setAttribute("myMoimList2" , mdao.getMyMoimList2(startRow,endRow,userid));
		
		
		
		ActionForward forward = new ActionForward();
		forward.setRedirect(false);
		forward.setPath("/app/moim/mymoimall.jsp");
		return forward;						
	}
}
