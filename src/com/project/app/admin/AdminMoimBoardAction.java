...
public class AdminMoimBoardAction implements Action{
	@Override
...
//		그때는 endPage를 가장 마지막 페이지 번호로 바꿔준다.
		...
		req.setAttribute("AdMoimList", adao.getAdMoimListAdmin(startRow,endRow,keyword));
		...
		forward.setPath("/app/admin/adminadmoim.jsp");
		return forward;
	}
}
