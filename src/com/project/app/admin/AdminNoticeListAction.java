...
//		전체 게시글의 개수
		int totalCnt = adao.getNoticeCnt(keyword);
...
//		그때는 endPage를 가장 마지막 페이지 번호로 바꿔준다.
		...
		req.setAttribute("boardList", adao.getNoticeList(startRow,endRow,keyword));
		...
		forward.setPath("/app/admin/adminnoticelist.jsp");
		return forward;
	}
}
