...
public class MoimListAction implements Action{
	@Override
...
//		전체 게시글의 개수
		int totalCnt = mdao.getMoimCnt(keyword);
...
//		그때는 endPage를 가장 마지막 페이지 번호로 바꿔준다.
		...
		req.setAttribute("moimList", adao.getMoimListAdmin(startRow,endRow,keyword));
		...
		forward.setPath("/app/admin/adminmoimlist.jsp");
		return forward;
	}
}
